...
async def test_basic_agent_registration_and_messaging(mcp_client, tmp_path):
    ...
    agent2_result = await mcp_client.call_tool("register_agent", {
        "project_key": str(project_path),
        "program": "codex-cli",
        "model": "gpt-5",
        "name": "TestAgent2",
    ...
    inbox_result = await mcp_client.call_tool("fetch_inbox", {
        "project_key": str(project_path),
...
async def test_thread_conversation_workflow(mcp_client, tmp_path):
    ...
    msg1_result = await mcp_client.call_tool("send_message", {
        "project_key": str(project_path),
    ...
    reply_result = await mcp_client.call_tool("reply_message", {
        "project_key": str(project_path),
        "message_id": msg1_id,
    ...
    inbox3 = await mcp_client.call_tool("fetch_inbox", {
        "project_key": str(project_path),
        "agent_name": agents[2],
        "include_bodies": True,
    })
...
async def test_acknowledgment_workflow(mcp_client, tmp_path):
    ...
    ack_result = await mcp_client.call_tool("acknowledge_message", {
        "project_key": str(project_path),
        "agent_name": agent2,
...
async def test_file_reservation_conflict_workflow(mcp_client, tmp_path):
    ...
    reserve1 = await mcp_client.call_tool("file_reservation_paths", {
        "project_key": str(project_path),
        "agent_name": agent1,
    ...
    reserve2 = await mcp_client.call_tool("file_reservation_paths", {
        "project_key": str(project_path),
        "agent_name": agent2,
    ...
    reserve3 = await mcp_client.call_tool("file_reservation_paths", {
        "project_key": str(project_path),
        "agent_name": agent2,
    ...
    release = await mcp_client.call_tool("release_file_reservations", {
        "project_key": str(project_path),
        "agent_name": agent1,
        "paths": ["src/backend/**/*.py"],
    })

    assert len(release.data["released"]) == 1
...
async def test_cross_project_messaging(mcp_client, tmp_path):
    ...
    inbox2 = await mcp_client.call_tool("fetch_inbox", {
        "project_key": str(project2_path),
        "agent_name": agent2,
    })
...
async def test_message_search(mcp_client, tmp_path):
    ...
    search_result = await mcp_client.call_tool("search_messages", {
        "project_key": str(project_path),
...
async def test_concurrent_message_sending(mcp_client, tmp_path):
    ...
    async def send_message_from_agent(sender_idx):
        return await mcp_client.call_tool("send_message", {
            "project_key": str(project_path),
    ...
    results = await asyncio.gather(*[
        send_message_from_agent(i) for i in range(1, 5)
    ])
...
async def test_whois_command(mcp_client, tmp_path):
    ...
    agent_result = await mcp_client.call_tool("register_agent", {
        "project_key": str(project_path),
        "program": "claude-code",
        "model": "claude-sonnet-4",
        "name": "CodeReviewer",
    ...
    whois_result = await mcp_client.call_tool("whois", {
        "project_key": str(project_path),
