...
main() {
  ...
  echo "    - Securely save credentials to ~/.mcp_agent_mail_git_mailbox_repo/credentials.json"
  echo "    - Test your Slack connection"
  echo ""
  echo "  Or configure manually in ~/.mcp_agent_mail_git_mailbox_repo/credentials.json:"
  echo ""
  echo "    mkdir -p ~/.mcp_agent_mail_git_mailbox_repo"
  echo "    cat > ~/.mcp_agent_mail_git_mailbox_repo/credentials.json <<'EOF'"
  echo "    {"
  ...
  echo "    }"
  echo "    EOF"
  echo "    chmod 600 ~/.mcp_agent_mail_git_mailbox_repo/credentials.json"
  echo ""
